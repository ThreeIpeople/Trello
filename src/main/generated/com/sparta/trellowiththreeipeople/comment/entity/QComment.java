...
public class QComment extends EntityPathBase<Comment> {
    ...
    private static final long serialVersionUID = -512813405L;
    ...
    public final com.sparta.trellowiththreeipeople.card.entity.QCard card;
    ...
    public QComment(Class<? extends Comment> type, PathMetadata metadata, PathInits inits) {
        ...
        this.card = inits.isInitialized("card") ? new com.sparta.trellowiththreeipeople.card.entity.QCard(forProperty("card"), inits.get("card")) : null;
