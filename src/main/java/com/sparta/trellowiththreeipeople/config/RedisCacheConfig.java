...
public class RedisCacheConfig {
    ...
    public RedisCacheManager cacheManager(RedisConnectionFactory redisConnectionFactory) {
        return RedisCacheManager.builder()
            ...
            .withCacheConfiguration("boardCache", boardCacheConfig())
            .withCacheConfiguration("cardCache", cardCacheConfig())
    ...
    @Bean
    protected RedisCacheConfiguration boardCacheConfig() {
        return RedisCacheConfiguration.defaultCacheConfig()
    ...
    @Bean
    protected RedisCacheConfiguration cardCacheConfig() {
        return RedisCacheConfiguration.defaultCacheConfig()
            .entryTtl(Duration.ofMinutes(10))
            .serializeKeysWith(keySerialization())
            .serializeValuesWith(valueSerialization())
